...
public class EditLead 
{
	...
	public static void main(String[] args) 
	{
		...
		WebElement editButtonElement = driver.findElement(By.linkText("Edit")); //Click on Create Button
		editButtonElement.click();
		WebElement editDescriptionElement = driver.findElement(By.id("updateLeadForm_description")); //Clear the Description Field using .clear()
		editDescriptionElement.clear();
		WebElement importantNoteElement = driver.findElement(By.id("updateLeadForm_importantNote")); // Fill ImportantNote Field with Any text
		importantNoteElement.sendKeys("Please fill this");
		WebElement updateButtonElement = driver.findElement(By.xpath("//input[@value='Update']")); //Click on update button 
